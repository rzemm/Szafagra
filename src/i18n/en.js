export const en = {
  ...
  createPartyPrep: 'Party preparation',
  createPartyPrepDesc: 'Everyone can add their music suggestions before the party.',
  createParty: 'Party',
  createPartyDesc: 'Voting mode — guests vote what plays next.',
  createPlayer: 'Player',
  ...
  partyConfigTitle: 'Party settings',
  partyConfigMaxSuggestionsLabel: 'How many proposals can each viewer submit?',
  partyConfigUnlimited: 'Unlimited',
  partyConfigRequireLogin: 'Logged-in users only',
  partyConfigCreate: 'Create room',
